 ...
 *
 * @author Donald Denbo
 * @version $Revision: 1.14 $ $Date: 2003/08/25 21:14:26 $
 * @since sgt 2.0
...
public abstract class SoTRange implements java.io.Serializable, Cloneable {
   ...
   public static class GeoDate extends SoTRange {
      ...
      public void add(SoTRange tr) {
         ...
         if (tRange.start.before(start)) {
            start = tRange.start;
         }
         if (tRange.end.after(end)) {
            end = tRange.end;
         }
      }
