...
public class Page extends JComponent implements PropertyChangeListener, Serializable, Printable {
   ...
   public void setDataModel(DataModel dataModel) {
      if (DEBUG) {
         System.out.println("Page.setDataModel()");
      }
   ...
   public void setPanelModel(PanelModel panelModel) {
      if (DEBUG) {
         System.out.println("Page.setPanelModel()");
      }
   ...
   public void propertyChange(PropertyChangeEvent evt) {
      ...
      if (source instanceof PanelModel) {
         if (DEBUG) {
            System.out.println("Page.propertyChange(PanelModel): " + property);
         }
         updatePanels();
         ...
         if (DEBUG) {
            System.out.println("Page.propertyChange(DataModel): " + property);
         }
         ...
         if (DEBUG) {
            System.out.println("Page.propertyChange(JPane): " + property);
         }
...
//        panel.setBorder(new EtchedBorder());
   ...
   public Panel findPanel(PanelHolder pHolder) {
      ...
      for (int i = 0; i < comps.length; i++) {
         if (comps[i] instanceof Panel) {
            if (((Panel) comps[i]).getName().equals(pHolder.getId())) {
