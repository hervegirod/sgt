...
public class CLTransformColorMap extends ColorMap
   ...
   public void setColorTransforms(Transform rTrans,
      ...
      if (!rTrans_.equals(rTrans)
         ...
         if (rTrans_ != null) {
            rTrans_.removePropertyChangeListener(this);
         }
         if (gTrans_ != null) {
            gTrans_.removePropertyChangeListener(this);
         }
         if (bTrans_ != null) {
            bTrans_.removePropertyChangeListener(this);
         }
   ...
   public boolean equals(ColorMap cm) {
      if (cm == null || !(cm instanceof CLTransformColorMap)) {
         return false;
      }
      if (!cl_.equals(((CLTransformColorMap) cm).cl_)) {
         return false;
      }
      if (!(rTrans_.equals(((CLTransformColorMap) cm).rTrans_)
         && gTrans_.equals(((CLTransformColorMap) cm).gTrans_)
         && bTrans_.equals(((CLTransformColorMap) cm).bTrans_))) {
         return false;
      }
      return true;
   }
